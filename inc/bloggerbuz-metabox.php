...
function bloggerbuz_sidebar_layout_callback(){ 
    ...
    <table class="form-table">
        <tr>
            <td colspan="4"><em class="f13"><?php echo esc_html__('Choose Sidebar Template','bloggerbuz');?></em></td>
        </tr>
